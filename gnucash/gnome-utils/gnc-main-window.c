...
{
    {
        "WindowTabPositionTopAction", NULL, N_("Tab position: _Top"), NULL,
        N_("Display the notebook tabs at the top of the window."), GTK_POS_TOP
    },
    {
        "WindowTabPositionBottomAction", NULL, N_("Tab position: _Bottom"), NULL,
        N_("Display the notebook tabs at the bottom of the window."), GTK_POS_BOTTOM
    },
    {
        "WindowTabPositionLeftAction", NULL, N_("Tab position: _Left"), NULL,
        N_("Display the notebook tabs at the left of the window."), GTK_POS_LEFT
    },
    {
        "WindowTabPositionRightAction", NULL, N_("Tab position: _Right"), NULL,
...
gnc_main_window_update_tab_position (gpointer prefs, gchar *pref, gpointer user_data)
{
    ...
    {
        /* No tab position preference - only set the default position
         * on the notebook once per window to avoid making multiple
         * changes when the preference is changed (and all of the
         * options are temporarily false). */
        ignore = priv->initial_tab_position_set;
    }
    ...
    if (!ignore)
    {
        ...
        for (i = 0; i < n_tab_pos_radio_entries; i++)
        {
