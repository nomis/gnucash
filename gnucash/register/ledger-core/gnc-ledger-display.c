...
static void
gnc_ledger_display_refresh_internal (GNCLedgerDisplay* ld, gboolean first);
...
refresh_handler (GHashTable* changes, gpointer user_data)
{
    ...
    gnc_ledger_display_refresh_internal (ld, FALSE);
    LEAVE (" ");
}
                             ...
                             gboolean mismatched_commodities)
{
    ...
    gnc_ledger_display_refresh_internal (ld, TRUE);
    return ld;
}
