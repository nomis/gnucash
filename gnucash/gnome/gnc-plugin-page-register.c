...
enum GncPrefJumpMultSplits {
    JUMP_DEFAULT = 0, /* Do nothing */
    JUMP_LARGEST_VALUE_SPLIT = 1,
    JUMP_SMALLEST_VALUE_SPLIT = 2,
};
...
{
    enum GncPrefJumpMultSplits mode = gnc_prefs_get_enum(GNC_PREFS_GROUP_GENERAL_REGISTER, GNC_PREF_JUMP_MULT_SPLITS);

    switch (mode) {
    case JUMP_LARGEST_VALUE_SPLIT:
        return jump_multiple_splits_by_value (account, split, TRUE);

    case JUMP_SMALLEST_VALUE_SPLIT:
